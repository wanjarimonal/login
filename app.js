...
// phone auth
  ...
  function onSignInSubmit() {
    ...
    $('#errorbox').hide();
   // updateSignInButtonUI();
   var aadhar = document.getElementById('aadhaar_no').value;
    var phoneNumber = "+91" + aadhaar_no_phone_no[aadhar];
...
$(verifyotp).click(function(){
    ...
    var code = document.getElementById('verify_otp').value;
